 ...
 *
 * This class stores color information for vertices and provides functionality
 * to bind and use the color data in rendering.
 */
class ColorBuffer {
    ...
    fun bind() {
        ...
        GLES20.glEnableVertexAttribArray(COLOR_ATTRIBUTE_LOCATION)
