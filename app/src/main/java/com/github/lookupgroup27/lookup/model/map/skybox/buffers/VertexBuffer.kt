 ...
 *
 * This class provides functionality to store and bind vertex positions for efficient use in the
 * rendering pipeline.
 */
class VertexBuffer {
  ...
  /**
   * Resets the buffer with the specified number of vertices. Allocates memory to store the vertex
   * data.
   *
