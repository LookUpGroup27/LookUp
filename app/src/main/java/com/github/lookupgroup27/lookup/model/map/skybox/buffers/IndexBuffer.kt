 ...
 *
 * This class stores indices that define the order of rendering vertices
 * and provides functionality to bind and draw the indices.
 */
class IndexBuffer {
    ...
    /**
     * Resets the buffer with the specified number of indices.
     * Allocates memory to store the index data.
     *
