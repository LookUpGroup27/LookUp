...
/**
 * Class to fetch nearby posts based on the user's current location and the time they were posted.
 *
 * @param postsViewModel The ViewModel that holds the list of all posts.
